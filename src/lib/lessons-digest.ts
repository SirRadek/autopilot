import { normalizeFailureTags, type FailureCategory } from './failure-taxonomy'
import type { IssueLedgerEntry } from './issue-ledger'

// Turns recorded lessons (issue-ledger `lesson_learned` + design `rule_updates`) into a
// compact, routable digest an agent packet can carry as context — without an optimizer
