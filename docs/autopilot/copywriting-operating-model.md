...
decision: Add a Copywriting operating model mapping the existing copywriting roles to models (Opus copywriter/technical writer, Gemini brand-voice reviewer, Qwen localization drafts), with a claims gate, the data-privacy axis, and an 11-copywriting prompt lane.
