...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Autopilot Control Plane | `autopilot-control-plane` | active process layer | `C:\Programování\Codex` | `SirRadek/autopilot` | `separated` | Governance docs, registry, ledgers, minimal TypeScript/Vitest governance contracts, Graphic Production Agent policy, Design Intelligence policy, free-cloud reasoning policy, local-worker routing policy, token-efficiency/Caveman policy, Autopilot operational Decision Mesh YAML/JSON context router, local read-only MCP server with structured output metadata, static read-only `/autopilot` command center, Prompt Library validator, Product & Design OS governance templates, schema/provenance validator, intake router, Markdown reports, scoring, and read-only MCP routes | None yet; control-plane deployment deferred | `docs/projects/autopilot-control-plane/architecture.md` | `docs/projects/autopilot-control-plane/work-log.md` | 2026-06-11 | 2026-06-18 | Delivery-system typed contracts, Prompt Library frontmatter/source/eval validation, Product & Design OS schema/provenance validation, YAML/TS capability drift checks, Autopilot operational Decision Mesh MCP, capability routing, context economy, model spend policy, project mesh seed, and static UI exist; external project inventory normalization is not implemented; package, MCP, and UI must remain read-only and non-executing |
