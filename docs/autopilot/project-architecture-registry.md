...
| Radeq.cz Website | `radeq` | active product project | `C:\Users\sirok\Documents\Projects\radeq` | `SirRadek/radeq` | `local_split_complete; remote_cleanup_pr_open` | Astro static site, React islands, Cloudflare Pages Function, D1 lead store | Cloudflare Pages target, GitHub Pages workflow for branch `new` | `docs/projects/radeq/architecture.md` | `docs/projects/radeq/work-log.md` | 2026-05-13 | 2026-05-20 | Radeq product checkout exists separately; legacy Autopilot docs still exist on the Radeq default branch until cleanup PR `https://github.com/SirRadek/radeq/pull/1` is reviewed and merged; Cloudflare gate is local proof only; performance and a11y budgets need expansion |
