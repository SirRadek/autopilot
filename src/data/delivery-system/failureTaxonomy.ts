/**
 * Fixed failure taxonomy (mesh-map gap G7, GPT-lane recommendation #3). Lessons and
 * issues tag failures from this closed set so the lessons digest can aggregate on
 * counts and repeated patterns instead of anecdotes. Free-text `lesson_learned` stays;
