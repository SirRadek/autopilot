...
forbidden:
  ...
  - raw_project_logs
  - delivery_approval
expected_output: Eval cases and good/bad references for the 09-analysis prompt lane.
evals:
...
Representative, fully-redacted cases for `09-analysis/`. They evaluate whether
